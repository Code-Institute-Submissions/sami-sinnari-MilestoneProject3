// Code below ahs been copies from Code Institue mini project for tasks, DB and Form Validation. LINK :
...
//     let sidenavsInstance = M.Sidenav.init(sidenavs, {edge: "left"});
